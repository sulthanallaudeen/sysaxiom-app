        ...
        <section class="no-padding wow fadeIn">
            <div class="container-fluid">
                <div class="row equalize xs-equalize-auto">
                    ...
                    <div class="col-md-4 c col-sm-12 col-xs-12 cover-background feature-box-1 xs-height-350px" style="background: url(http://placehold.it/900x650)"></div>
                </div>
            </div>
        </section>
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12 team-block text-left feature-box-15 xs-margin-30px-bottom wow fadeInUp">
                        <figure>
                            <div class="feature-box-content xs-width-100">
                                <div class="feature-box-image"><img src="http://placehold.it/750x500" alt=""></div>
