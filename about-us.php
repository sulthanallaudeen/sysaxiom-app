                ...
                <div class="row equalize sm-equalize-auto"> 
                    ...
                    <div class="col-md-7 col-sm-12 col-xs-12 display-table wow fadeInRight">
                        <div class="display-table-cell vertical-align-middle text-center xs-no-padding-right">
                            <img src="http://placehold.it/850x550" alt="" class="width-100">
                        </div>
                    </div> 
                </div>
            </div>
        ...
        <section class="wow fadeIn">
            <div class="container">
                ...
                <div class="row">
                                ...
                                <div class="overlay-content text-center">
                                    <div class="display-table height-100 width-100">
                                        <div class="vertical-align-bottom display-table-cell icon-social-small padding-twelve-all">
                                            ...
                                            <a href="http://facebook.com" class="text-white" target="_blank"><i class="fab fa-facebook-f"></i></a>
                    ...
                    <!-- end team item -->
                    <!-- start team item -->
                    <div class="col-md-3 col-sm-6 col-xs-12 team-block text-left team-style-1 xs-margin-30px-bottom wow fadeInRight" data-wow-duration="900ms" data-wow-delay="0.4s">
                        <figure>
                            <div class="team-image xs-width-100">
                                <img src="http://placehold.it/700x892" alt="">
                                <div class="overlay-content text-center">
                    ...
                    <!-- end team item -->
                    <!-- start team item -->
                    <div class="col-md-3 col-sm-6 col-xs-12 team-block text-left team-style-1 wow fadeInRight" data-wow-duration="900ms" data-wow-delay="0.6s">
                        <figure>
                            <div class="team-image xs-width-100">
                                <img src="http://placehold.it/700x892" alt="">
                                <div class="overlay-content text-center">
